<template>
  <footer :class="[isDark ? 'footer-dark' : 'footer-light']">
    ...
    <section class="d-flex flex-column flex-md-row justify-content-between align-items-center p-4" :class="[isDark ? 'social-dark' : 'social-light']">
    ...
    <div class="text-center p-3" :class="[isDark ? 'copyright-dark' : 'copyright-light']">
      © 2025 - C-Alicia. Tous droits réservés.
    </div>
  </footer>
</template>
...
/* Responsive : texte centré en mobile mais carte pleine largeur */
